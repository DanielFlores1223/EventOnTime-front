...
const routes: Routes = [
  ...
  {path: 'planificador/eventos/add', component:EventosformComponent, canActivate: [AuthGuard]},
  {path: 'planificador/eventos/edit/:id', component:EventosformComponent, canActivate: [AuthGuard]},
